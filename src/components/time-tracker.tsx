        ...
        <Card className="w-full">
            ...
            <CardContent className="space-y-6">
                <div className="text-center">
                    <div className="text-4xl font-mono font-bold text-gray-900">{currentTime.toLocaleTimeString("vi-VN")}</div>
                ...
                <div className="text-center space-y-4">
                    ...
                    {isCheckedIn && (
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500">Bắt đầu lúc: {checkInTime?.toLocaleTimeString("vi-VN")}</p>
                        </div>
                    )}
